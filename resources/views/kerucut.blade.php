...
<html lang="en">
  <head>
    ...
    <title>Hitung Volume | Kerucut</title>
    <style type="text/css">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <form class="container mt-5" action="/hitungkerucut" method="GET" >
      <div class="row justify-content-center">
        <div class="col-6">
          <div class="card border-primary">
            <div class="card-header font-weight-bold text-white bg-primary mb-3">
              <div class="row">
                <div class="col text-left">Hitung Volume Kerucut</div>
            ...
            <div class="card-body p-5">
              ...
              <div class="form-group row">
                ...
                <input type="number" name="tinggi" id="text" class="form-control col-12" placeholder="Masukkan Tinggi Disini">
              </div>
              <div class="form-group row">
